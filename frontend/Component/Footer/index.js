...
const Footer = () => {
  ...
  return (
    ...
    <footer>
      <div className="container-fluid text-light footer mt-5 pt-5 wow fadeIn" data-wow-delay="0.1s">
        <div className="container py-5 px-lg-5">
          <div className="row g-5">
            <div className="col-md-6 col-lg-4">
              <h5 className="text-white mb-4">Get In Touch</h5>
              <p>
                <i className="fa fa-map-marker-alt me-3"></i>Chennai, TamilNadu
              </p>
              <p>
            ...
            <div className="col-md-6 col-lg-4">
              ...
              <a className="btn btn-link" href={`/${offmail}/Dasjhboard`}>
                Dashboard
              </a>
            </div>
            <div className="col-md-6 col-lg-4">
  ...
  <path d="M16 8.049c0-4.446-3.582-8.05-8-8.05C3.58 0-.002 3.603-.002 8.05c0 4.017 2.926 7.347 6.75 7.951v-5.625h-2.03V8.05H6.75V6.275c0-2.017 1.195-3.131 3.022-3.131.876 0 1.791.157 1.791.157v1.98h-1.009c-.993 0-1.303.621-1.303 1.258v1.51h2.218l-.354 2.326H9.25V16c3.824-.604 6.75-3.934 6.75-7.951z"/>
                ...
                <a className="btn btn-outline-light btn-social" href="https://www.instagram.com">
